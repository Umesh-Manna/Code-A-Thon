...
import { NavLink, useNavigate } from 'react-router-dom'; // Ensure useNavigate is here
import { 
  LayoutDashboard, 
  Calendar, 
  Eye, 
...
const Sidebar = ({ isCollapsed, onToggle }) => {
  const navigate = useNavigate(); // Correctly initialized inside the component

  // State to hold the user info from Supabase
  ...
  // Helper to get dynamic initials (e.g. "Sairaj Kotian" -> "SK")
