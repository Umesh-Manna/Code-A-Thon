...
//   useEffect(() => {
//     fetch(`http://localhost:8000/api/sky-weather?country=${country}`)
//       .then(res => res.json())
//       .then(setData)
//       .catch(console.error);
//   }, [country]);
...
//   if (!data) {
//     return (
//       <div className="bg-white/5 rounded-2xl p-5 text-white/40">
//         Loading sky data…
//       </div>
//     );
//   }
...
//       className="bg-white/5 backdrop-blur-xl rounded-2xl p-5 border border-white/10 shadow-lg relative"
//     >
//       {/* HEADER */}
//       <div className="flex justify-between items-center mb-3">
//         <h2 className="text-lg font-semibold">🌌 Sky Quality</h2>
...
//                 animate={{ opacity: 1, y: 0 }}
//                 exit={{ opacity: 0 }}
//                 className="absolute right-0 mt-2 w-48 bg-[#0f0f1a] border border-white/10 rounded-xl shadow-xl z-50"
//               >
//                 <input
//                   placeholder="Search..."
//                   className="w-full px-3 py-2 text-xs bg-transparent border-b border-white/10 outline-none"
//                   value={query}
...
//         <p>☁ Clouds: {data.cloudCover}%</p>
//         <p>🌬 Wind: {data.wind} km/h</p>
//         <p>🌡 Temp: {data.temperature}°C</p>
//         <p>🌙 Moon: {data.moonImpact}</p>
//       </div>
